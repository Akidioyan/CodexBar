...
public enum ProviderTokenResolver {
    ...
    public static func codeBuddyToken(environment: [String: String] = ProcessInfo.processInfo.environment) -> String? {
        self.codeBuddyResolution(environment: environment)?.token
    }
    ...
    public static func codeBuddyResolution(
        environment: [String: String] = ProcessInfo.processInfo.environment) -> ProviderTokenResolution?
    {
        self.resolveEnv(self.cleaned(environment["CODEBUDDY_API_KEY"]))
    }
